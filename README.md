# iPAS資安工程師中級 | 防護實務衝刺班 | 筆記說明
> 此 repository 為 iPAS 資安工程師 中級證照筆記 範圍將著重在【防護實務】並以【歷屆難題與解析】與【名詞工具重點說明】方式呈現。
...
> 同時在本筆記的最底下 用【Refer】來致敬網上的大大與前輩\
> 他們的 iPAS 資安中級筆記都非常厲害 是我撰寫本筆記的動力來源 本筆記內容部分將不與他們重疊\
> 希望本篇能對正在學習的你有重點整理之幫助
